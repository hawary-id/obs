      ...
      <div className="w-1/3 border-none md:border-r pr-3">
        <div className="flex mb-3 items-center justify-center space-x-4">
          <Avatar className="h-24 w-24 border">
            <AvatarImage
              src={`https://api.dicebear.com/5.x/micah/svg?seed=${formData?.id}`}
            />
        ...
        <h1 className="text-center text-lg text-primary inline-block w-full font-semibold">
          {formData?.name}
        </h1>
        <span className="font-light inline-block w-full text-center text-xs">
          @{formData?.username}
        </span>
      </div>
      <div className="grid gap-3">
        ...
        <div className="w-full flex items-center gap-2">
          ...
          <span className="text-gray-600">
            {formData?.address?.street}, {formData?.address?.suite}
          </span>
        </div>
        <div className="w-full flex items-center gap-2">
